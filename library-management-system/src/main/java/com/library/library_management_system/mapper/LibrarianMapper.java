...
public interface LibrarianMapper {
    ...
    @Mapping(target = "shiftId", source = "librarian.shift.shiftId")
    @Mapping(target = "shiftName", source = "librarian.shift.shiftName")
    @Mapping(target = "timeShift", source = "librarian.shift.timeShift")
    @Mapping(target = "hoursPerDay", source = "librarian.shift.hoursPerDay")
    ...
    LibrarianResponse toResponse(Librarian librarian, BigDecimal hourlyWage, YearMonth salaryMonth, BigDecimal totalSalary);
